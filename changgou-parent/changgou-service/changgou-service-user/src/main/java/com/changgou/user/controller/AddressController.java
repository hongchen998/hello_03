...
/**
 * @author hongchen
 * @Description 获取当前登录人地址
 * @Date 23:47 2020/4/18
 * @param
 * @return entity.Result<java.util.List<com.changgou.user.pojo.Address>>
 **/
    ...
    public Result<List<Address>> list() {
        ...
        return new Result<>(true, StatusCode.OK, "获取地址列表成功", list);
    }
