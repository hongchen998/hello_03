...
public class SpecController {
     ...
     * @return
     */
    @GetMapping("/findSpecListByCategoryId/{categoryId}")
    public Result<Spec> findSpecListByCategoryId(@PathVariable Integer categoryId){
        List<Spec> specList = specService.findSpecListByCategoryId(categoryId);
