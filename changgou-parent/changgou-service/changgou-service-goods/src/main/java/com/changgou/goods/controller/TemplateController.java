...
public class TemplateController {
     ...
     * @return
     */
    @GetMapping("/findTemplateByCategoryId/{categoryId}")
    public Result<Template> findTemplateByCategoryId(@PathVariable Integer categoryId){
        Template template = templateService.findTemplateByCategoryId(categoryId);
