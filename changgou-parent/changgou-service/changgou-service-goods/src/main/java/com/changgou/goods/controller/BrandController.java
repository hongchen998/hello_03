...
public class BrandController {
     ...
     * @return
     */
    @GetMapping(value = "/findBrandListByCategoryId/{categoryId}" )
    public Result<Brand> findfindBrandListByCategoryIdPage(@PathVariable(value = "categoryId") Integer categoryId){
        List<Brand> brandList = brandService.findBrandListByCategoryId(categoryId);
