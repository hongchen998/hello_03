...
public class SpuController {
     ...
     * @return
     */
    public Result isDelete(long id, String isDelete) {
    ...
    public Result isShow(@PathVariable long id, @PathVariable String isMarketable) {
    ...
    public Result audit(@PathVariable long id, @PathVariable String status) {
